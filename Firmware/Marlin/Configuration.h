...
#define STRING_CONFIG_H_AUTHOR "(3D Print FIT CVUT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Rebelix-PEI"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,4000,420}  // default steps per unit for Ultimaker
